...
# 77 353 - 116 029
# 166 030 - 154706
max(data$course_enrollmenters)

data <- data%>%
  mutate(popularity = case_when((data$course_enrollmenters <= 38676) ~ 1, (data$course_enrollmenters > 38677  & data$course_enrollmenters <= 77353) ~ 2, (data$course_enrollmenters > 77354  & data$course_enrollmenters <= 116029) ~ 3, (data$course_enrollmenters > 166030) ~ 4))
